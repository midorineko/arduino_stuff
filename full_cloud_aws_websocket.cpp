...
char aws_endpoint[]    = "a2pvzpq52fxqx8.iot.us-east-1.amazonaws.com";
char aws_key[]         = "AKIAII6KTHGCFBSQ3O6A";
char aws_secret[]      = "AWS SECRET";
char aws_region[]      = "us-east-1";
const char* aws_topic  = "$aws/things/denEsp/shadow/update/delta";
int port = 443;
//MQTT config
